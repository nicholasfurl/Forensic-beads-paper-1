...
%to each suspect in each participant.

%works for study 2 only. Separate code for study 1.
...
params(2) = .7;    %split term, initialised to optimal value
...
%ensure loop outputs line up with data by sorting data by participant, then
%suspect, then context
...
for participant = 1:num_participants;
    ...
    %This code now does Study 2 so this should always return two suspects: 0 and 1
